...
var App = function () {
  ...
  _createClass(App, null, [{
    ...
    value: function init() {
      ...
      var user_token = rand() + rand();
      var socket = new _phoenix.Socket("/socket", { params: { token: user_token } });
      socket.connect();
      socket.onOpen(function (ev) {
        return console.log("SOCKET OPEN", ev);
      });
      socket.onError(function (ev) {
        return console.log("SOCKET ERROR", ev);
      });
      socket.onClose(function (e) {
        return console.log("SOCKET CLOSE", e);
      });

      var $login_body = (0, _jquery2.default)("#login_body");
      var $review_body = (0, _jquery2.default)("#review_body");
      var $login_error = (0, _jquery2.default)("#login_error_image");
      var $login_button = (0, _jquery2.default)("#login_button");
      ...
      var show_review = function show_review(socket) {
        $login_body.hide();
        $review_body.show();
      };

      var hide_login_error = function hide_login_error() {
        $login_error.hide();
      };

      var show_login_error = function show_login_error(socket) {
        $login_error.show();
        setTimeout(hide_login_error, 2000);
      };

      var hide_overlay = function hide_overlay() {
        $overlay.hide();
        $overlay_image.attr("src", "");
      };
      var show_overlay_image = function show_overlay_image(image) {
      ...
      $login_button.click(function () {
        ...
        chan.join().receive("error", function () {
      ...
      (0, _jquery2.default)('#password').keyup(function (e) {
      ...
      var start_review = function start_review(chan) {
        var $image = (0, _jquery2.default)("#image");
        var $good_button = (0, _jquery2.default)("#good");
        var $bad_button = (0, _jquery2.default)("#bad");
        var $next_button = (0, _jquery2.default)("#next");
        var $undo_button = (0, _jquery2.default)("#undo");
        var $images_left = (0, _jquery2.default)("#images_left");
        var $reviewed_count = (0, _jquery2.default)("#reviewed_count");
        var $online = (0, _jquery2.default)("#online");
        var $overlay = (0, _jquery2.default)("#overlay");
        var $overlay_image = (0, _jquery2.default)("#overlay_image");
        ...
        chan.on("new_image", function (msg) {
        ...
        var increment_reviewed = function increment_reviewed() {
          var value = parseInt($reviewed_count.text(), 10) + 1;
          $reviewed_count.text(value);
        };

        var decrement_reviewed = function decrement_reviewed() {
        ...
        var review = function review(rating) {
          var poll_next = (0, _jquery2.default)('#auto_next').is(":checked");
          chan.push("submit_review", { review: rating, auto_next: poll_next });
        };

        var poll_image = function poll_image() {
        ...
        (0, _jquery2.default)(document).keydown(function (e) {
          if (e.keyCode == 38 || e.keyCode == 75) {
            ...
            // right arrow  or n
            $next_button.click();
          } else if (e.keyCode == 37 || e.keyCode == 85) {
            // left arrow  or u
            $undo_button.click();
          } else {
            return true;
...
require('js/app');
//# sourceMappingURL=./app.js-2bd1549211638ddd0abcad483ff4bfff.map